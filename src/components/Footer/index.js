...
const Footer = () => {
  return (
    <div className="container-fluid bg-grey">
      ...
      <p className="footer-para text-center">Email Us -<a href="www.gmail.com"> payal2001om@gmail.com</a> or call us at<a href="#"> +91-9634135114</a> or WhatsApp at<a href="www.whatsapp.com">+91-7383528890</a> (from 10 AM to 6 PM, Mon to Sun). We are closed on bank holidays.</p>
      </div>
    </div>
  );
};
